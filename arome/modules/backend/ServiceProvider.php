...
class ServiceProvider extends ModuleServiceProvider
{
    ...
    protected function registerBackendReportWidgets()
    {
        WidgetManager::instance()->registerReportWidgets(function ($manager) {
            ...
            $manager->registerReportWidget(\Backend\ReportWidgets\Selling::class, [
                'label'   => 'backend::lang.dashboard.selling.widget_title_default',
                'context' => 'dashboard'
            ]);
            $manager->registerReportWidget(\Backend\ReportWidgets\Revenue::class, [
                'label'   => 'backend::lang.dashboard.revenue.widget_title_default',
                'context' => 'dashboard'
            ]);
        });
    }
