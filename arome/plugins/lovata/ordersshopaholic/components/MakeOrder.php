...
class MakeOrder extends ComponentSubmitForm
{
    ...
    public function onFe()
    {
        $updateChannel = Http::get('https://services.ghtklab.com/services/shipment/fee', function($http) {
            $http->header('Token', '64f858A205982073407e3188A98cC8D651542575');
            $http->header('Content-Type', 'application/json');
            $http->data((array) Input::get('calcShip'));
